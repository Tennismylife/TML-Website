...
const WHITELIST_RAW: WhitelistEntry[] = [
  ...
  { slug: ['seasons', 'wins'], filters: { surface: ['Hard'] }, title: 'Most Hard Court Match Wins in a Single Season', canonicalPath: '/records/most-hard-court-wins-in-a-single-season' },
  { slug: ['seasons', 'wins'], filters: { surface: ['Clay'] }, title: 'Most Clay Court Match Wins in a Single Season', canonicalPath: '/records/most-clay-court-wins-in-a-single-season' },
  { slug: ['seasons', 'wins'], filters: { surface: ['Grass'] }, title: 'Most Grass Court Match Wins in a Single Season', canonicalPath: '/records/most-grass-court-wins-in-a-single-season' },
  ...
  { slug: ['seasons', 'played'], filters: { surface: ['Hard'] }, title: 'Most Hard Court Matches Played in a Single Season', canonicalPath: '/records/most-hard-court-matches-played-in-a-single-season' },
