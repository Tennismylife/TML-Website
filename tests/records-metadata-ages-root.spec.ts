...
describe('ages root metadata', () => {
  it('returns canonical under /ages for the ages tab', async () => {
    ...
    expect((meta as any).alternates?.canonical).toBe('https://stats.tennismylife.org/tournaments/australian-open/ages');
  });
  ...
  it('returns tournament-specific canonical for youngest/oldest title subpages', async () => {
    ...
    expect((ym as any).alternates?.canonical).toBe('https://stats.tennismylife.org/tournaments/australian-open/ages/titles/youngest');
    ...
    expect((om as any).alternates?.canonical).toBe('https://stats.tennismylife.org/tournaments/australian-open/ages/titles/oldest');
  });
});
