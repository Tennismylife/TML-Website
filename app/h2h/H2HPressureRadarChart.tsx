...
export default function H2HPressureRadarChart({ p1Stats, p2Stats, p1Name, p2Name }: Props) {
  const data = [
    { label: "Deciding Set",   p1: pct(p1Stats.winsDecidingSet,     p1Stats.lossesDecidingSet),     p2: pct(p2Stats.winsDecidingSet,     p2Stats.lossesDecidingSet) },
    { label: "5th Set",        p1: pct(p1Stats.winsFifthSet,        p1Stats.lossesFifthSet),        p2: pct(p2Stats.winsFifthSet,        p2Stats.lossesFifthSet) },
    { label: "After Win 1st",  p1: pct(p1Stats.winsAfterWin1st,    p1Stats.lossesAfterWin1st),    p2: pct(p2Stats.winsAfterWin1st,    p2Stats.lossesAfterWin1st) },
    { label: "After Loss 1st", p1: pct(p1Stats.winsAfterLoss1st,   p1Stats.lossesAfterLoss1st),   p2: pct(p2Stats.winsAfterLoss1st,   p2Stats.lossesAfterLoss1st) },
    { label: "Win 1+2",        p1: pct(p1Stats.winsAfterWin1st2nd, p1Stats.lossesAfterWin1st2nd), p2: pct(p2Stats.winsAfterWin1st2nd, p2Stats.lossesAfterWin1st2nd) },
    { label: "Loss 1+2",       p1: pct(p1Stats.winsAfterLoss1st2nd,p1Stats.lossesAfterLoss1st2nd),p2: pct(p2Stats.winsAfterLoss1st2nd,p2Stats.lossesAfterLoss1st2nd) },
    { label: "Deciding TB",    p1: pct(p1Stats.winsDecidingTB,     p1Stats.lossesDecidingTB),     p2: pct(p2Stats.winsDecidingTB,     p2Stats.lossesDecidingTB) },
