...
function WinPctRow({
  label, p1, p2, p1Name, p2Name,
}: { label: string; p1: number | null; p2: number | null; p1Name: string; p2Name: string }) {
...
export default function H2HRankingRadarChart({ p1Stats, p2Stats, p1Name, p2Name }: Props) {
  const rows = [
    { label: "vs Top 1",    p1: pct(p1Stats.winsVsTop1,       p1Stats.lossesVsTop1),       p2: pct(p2Stats.winsVsTop1,       p2Stats.lossesVsTop1) },
    { label: "vs Top 5",    p1: pct(p1Stats.winsVsTop5,       p1Stats.lossesVsTop5),       p2: pct(p2Stats.winsVsTop5,       p2Stats.lossesVsTop5) },
    { label: "vs Top 10",   p1: pct(p1Stats.winsVsTop10,      p1Stats.lossesVsTop10),      p2: pct(p2Stats.winsVsTop10,      p2Stats.lossesVsTop10) },
    { label: "vs Top 20",   p1: pct(p1Stats.winsVsTop20,      p1Stats.lossesVsTop20),      p2: pct(p2Stats.winsVsTop20,      p2Stats.lossesVsTop20) },
    { label: "vs Top 100",  p1: pct(p1Stats.winsVsTop100,     p1Stats.lossesVsTop100),     p2: pct(p2Stats.winsVsTop100,     p2Stats.lossesVsTop100) },
    { label: "vs +100",     p1: pct(p1Stats.winsVsOutside100, p1Stats.lossesVsOutside100), p2: pct(p2Stats.winsVsOutside100, p2Stats.lossesVsOutside100) },
    { label: "vs Higher",   p1: pct(p1Stats.winsVsHigher,     p1Stats.lossesVsHigher),     p2: pct(p2Stats.winsVsHigher,     p2Stats.lossesVsHigher) },
    { label: "vs Lower",    p1: pct(p1Stats.winsVsLower,      p1Stats.lossesVsLower),      p2: pct(p2Stats.winsVsLower,      p2Stats.lossesVsLower) },
  ];
  ...
  return (
    <div className="w-full">
      ...
      <div className="divide-y divide-gray-800">
        {rows.map((r) => (
          <WinPctRow key={r.label} label={r.label} p1={r.p1} p2={r.p2} p1Name={p1Name} p2Name={p2Name} />
        ))}
      </div>
    </div>
  );
