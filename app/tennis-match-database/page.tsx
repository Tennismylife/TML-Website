...
<section className="mb-8 w-full px-6 text-center bg-gray-800/70 py-6">
  <div className="mx-auto max-w-3xl">
    ...
    <p className="text-lg sm:text-xl font-medium text-gray-100">
      <span className="!text-green-400 font-semibold">Barcelona</span> and <span className="!text-green-400 font-semibold">Munich</span> are currently in progress — live results and stats are being updated in real-time.
    </p>
  </div>
</section>
