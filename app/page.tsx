    ...
    <main className="w-full px-4 sm:px-6">
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-0 opacity-20 group-hover:opacity-30 transition-opacity duration-500"
          style={{ background: 'radial-gradient(ellipse at 70% 50%, #22d3ee 0%, transparent 70%)' }} />

        {/* Left accent bar */}
        <div className="w-1.5 flex-shrink-0" style={{ background: 'linear-gradient(to bottom, #22d3ee, #0891b2)' }} />

        <div className="flex flex-col sm:flex-row items-center gap-6 w-full px-6 py-8 sm:px-10">
          {/* Icon */}
          <div className="flex-shrink-0 flex items-center justify-center w-20 h-20 rounded-full border-2 border-cyan-400/40 bg-cyan-400/10 shadow-lg shadow-cyan-500/20 text-4xl select-none">
            🌴
          </div>
          ...
          <div className="flex-1 text-center sm:text-left">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
              <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight"
                ...
                Miami Open
                <span className="ml-2" style={{ color: '#0891b2', WebkitTextFillColor: '#0891b2' }}>Records</span>
              </h2>
              {/* LIVE badge */}
          ...
          {/* CTA arrow */}
          <div className="flex-shrink-0 hidden sm:flex items-center justify-center w-10 h-10 rounded-full border border-cyan-400/30 group-hover:border-cyan-400 group-hover:bg-cyan-400/10 transition-all duration-300">
