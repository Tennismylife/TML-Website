...
export default async function HomePage() {
  ...
  return (
    <main className="w-full px-4 sm:px-6">
      ...
      {/* Featured Cincinnati Records LIVE banner */}
      <div className="w-full mb-8">
        <a
          href="/tournaments/cincinnati-masters/records"
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 w-full px-6 py-8 sm:px-10">
            ...
            <div className="flex-1 text-center sm:text-left">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2">
                ...
                <span
                  className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold self-start sm:self-auto"
              ...
              <p className="text-sm sm:text-base text-gray-300 max-w-lg">
                All-time Cincinnati stats, milestones and history from the Queen City’s Masters 1000 — updated in real time.
              </p>
            </div>
