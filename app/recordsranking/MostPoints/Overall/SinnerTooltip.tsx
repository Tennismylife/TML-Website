...
export default function SinnerTooltip() {
  ...
  const tooltip = (
    ...
    >
      <div className="mb-3 text-base font-semibold text-white">Ranking at 25/05/2026</div>
      ...
      <div className="mt-2 grid grid-cols-[1.7fr_0.8fr_0.8fr_0.9fr_0.9fr] gap-2 text-sm text-gray-200">
        ...
        <span>US Open</span><span className="text-center">2025</span><span className="text-center">F</span><span className="text-center">1200</span><span className="text-center">1300</span>
        <span>Roland Garros</span><span className="text-center">2025</span><span className="text-center">F</span><span className="text-center">1200</span><span className="text-center">1300</span>
        <span>Australian Open</span><span className="text-center">2026</span><span className="text-center">SF</span><span className="text-center">720</span><span className="text-center">800</span>
        ...
        <span>Cincinnati Masters</span><span className="text-center">2025</span><span className="text-center">F</span><span className="text-center">600</span><span className="text-center">650</span>
        <span>Shanghai Masters</span><span className="text-center">2025</span><span className="text-center">R32</span><span className="text-center">45</span><span className="text-center">50</span>
        ...
        <span>Doha</span><span className="text-center">2026</span><span className="text-center">QF</span><span className="text-center">90</span><span className="text-center">100</span>
        <span>Halle</span><span className="text-center">2025</span><span className="text-center">R16</span><span className="text-center">45</span><span className="text-center">50</span>
      </div>
      <div className="mt-3 grid grid-cols-[1.7fr_0.8fr_0.8fr_0.9fr_0.9fr] gap-2 border-t border-white/10 pt-2 text-sm font-semibold text-white">
        ...
        <span></span>
        <span></span>
        <span className="text-center">14,400</span>
        <span className="text-center">14,750</span>
      </div>
    </div>
  );
