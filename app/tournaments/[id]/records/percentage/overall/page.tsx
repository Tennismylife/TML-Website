...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }) {
  ...
  const ogUrl = `${site}/tournaments/${canonicalSlug}/records/percentage/overall`;
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: `${site}/og/site-preview.png`, alt: `${tournamentName} - Best Winning Percentage`, width: 1200, height: 630, type: 'image/png' }],
    },
    twitter: { card: 'summary_large_image', title, description, images: [`${site}/og/site-preview.png`] },
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Records', item: `${site}/tournaments/${slugId}/records` },
              { '@type': 'ListItem', position: 5, name: 'Best Win Percentage', item: canonical },
            ],
          }),
        }}
      />
