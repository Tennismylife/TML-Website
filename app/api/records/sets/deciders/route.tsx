...
function isDeciderSets(score: string | null, bestOf: number | null): boolean {
  ...
  return winnerSets === required && loserSets === required - 1;
}
...
export async function GET(request: NextRequest) {
  try {
    ...
    matches = matches.filter(m => isDeciderSets(m.score, m.best_of));
