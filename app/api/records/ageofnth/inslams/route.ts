...
export async function GET(request: NextRequest) {
  try {
    ...
    // read filters from query (keep optional)
    ...
    const cacheKey = JSON.stringify({ dbCount, selectedSurfaces, selectedBestOf, selectedRounds });
    ...
    // --- Fetch matches (Grand Slams only) ---
