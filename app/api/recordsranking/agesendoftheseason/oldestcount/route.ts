// app/api/recordsranking/oldest-eoy/route.ts
...
export async function GET(req: Request) {
  try {
    ...
    // 1) Recupera anni disponibili (con eventuali bound)
    const dateWhere: any = {};
    ...
    // 4) Per ciascun player: conserva l'occorrenza con età MASSIMA
    type MaxRec = {
      name: string;
      ioc: string | null;
      year: number;
    ...
    console.error("Error computing oldest EOY at rank X:", error);
