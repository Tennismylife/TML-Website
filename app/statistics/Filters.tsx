    ...
    <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700 mb-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="flex flex-col">
          <label className="mb-2 font-medium text-white text-sm">Surface:</label>
          <select
            value={surface}
        ...
        <div className="flex flex-col">
          <label className="mb-2 font-medium text-white text-sm">Season:</label>
          <select
            value={year}
        ...
        <div className="flex flex-col">
          <label className="mb-2 font-medium text-white text-sm">Category:</label>
          <select
            value={tourneyLevel}
