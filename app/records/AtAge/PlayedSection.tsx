      ...
      <table className="min-w-full border-collapse">
        <thead>
          <tr className="bg-black">
            ...
            <th className="border border-white/30 px-4 py-2 text-center text-lg text-gray-200">Played at {selectedAge.toFixed(3)}</th>
          </tr>
        </thead>
        <tbody>
          {players.map((p, idx) => {
  ...
  return (
    <section className="mb-8">
      ...
      <Modal
        ...
        title={`Top Matches Played at Age ${selectedAge.toFixed(3)}`}
      >
        {renderTable(data)}
      </Modal>
    </section>
