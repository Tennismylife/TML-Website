    ...
    <section className="mb-0">
      ...
      {isMasters1000Only && (
        <div className="mb-6 text-base leading-7 text-gray-300">
          ...
          <p className="mb-4">
            The streak began after Sinner’s last Masters 1000 defeat in <Link href={getTourneyHref({ slug: 'shanghai', year: 2025 })} className="text-indigo-300 no-underline hover:text-indigo-200">Shanghai 2025</Link> and has included a remarkable sequence of titles: <Link href={getTourneyHref({ slug: 'paris-masters', year: 2025 })} className="text-indigo-300 no-underline hover:text-indigo-200">Paris 2025</Link>, <Link href={getTourneyHref({ slug: 'indian-wells-masters', year: 2026 })} className="text-indigo-300 no-underline hover:text-indigo-200">Indian Wells 2026</Link>, <Link href={getTourneyHref({ slug: 'miami-masters', year: 2026 })} className="text-indigo-300 no-underline hover:text-indigo-200">Miami 2026</Link>, <Link href={getTourneyHref({ slug: 'monte-carlo-masters', year: 2026 })} className="text-indigo-300 no-underline hover:text-indigo-200">Monte-Carlo 2026</Link> and <Link href={getTourneyHref({ slug: 'madrid-masters', year: 2026 })} className="text-indigo-300 no-underline hover:text-indigo-200">Madrid 2026</Link>, making him the first man to win five consecutive Masters 1000 tournaments.
          </p>
          <p className="mb-4">
