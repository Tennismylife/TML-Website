...
export default function YoungestMainDraw({ selectedSurfaces, selectedLevels, selectedRounds, fetchEnabled, fetchRequestId, description, initialData, currentPath }: YoungestMainDrawProps) {
  ...
  return (
    <section className="mb-8">
      ...
      {isPath('/records/youngest-players-in-main-draw-at-grand-slam') && selectedSurfaces?.size === 0 && selectedLevels?.has('G') && selectedRounds === '' && (
      ...
      {isPath('/records/youngest-grand-slam-finalists') && selectedSurfaces?.size === 0 && selectedLevels?.has('G') && selectedRounds === 'F' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/youngest-grand-slam-quarterfinalists') && selectedSurfaces?.size === 0 && selectedLevels?.has('G') && selectedRounds === 'QF' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/youngest-grand-slam-semifinalists') && selectedSurfaces?.size === 0 && selectedLevels?.has('G') && selectedRounds === 'SF' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/youngest-players-in-main-draw-at-masters-1000') && selectedSurfaces?.size === 0 && selectedLevels?.has('M') && selectedRounds === 'F' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/youngest-players-in-main-draw-at-masters-1000') && selectedSurfaces?.size === 0 && selectedLevels?.has('M') && selectedRounds === 'SF' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/youngest-players-in-main-draw-at-masters-1000') && selectedSurfaces?.size === 0 && selectedLevels?.has('M') && selectedRounds === 'QF' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/youngest-players-in-main-draw-at-masters-1000') && selectedSurfaces?.size === 0 && selectedLevels?.has('M') && selectedRounds === '' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
