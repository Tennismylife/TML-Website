...
export default function YoungestMainDraw({ selectedSurfaces, selectedLevels, selectedRounds }: YoungestMainDrawProps) {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const url = `/api/records/ages/maindraw?${query.toString()}`;
