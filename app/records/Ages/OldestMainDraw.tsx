...
export default function OldestMainDraw({ selectedSurfaces, selectedLevels, selectedRounds, fetchEnabled, fetchRequestId, description, initialData, currentPath }: OldestMainDrawProps) {
  ...
  return (
    <section className="mb-8">
      ...
      {isPath('/records/oldest-players-in-main-draw-at-grand-slam') && selectedSurfaces?.size === 0 && selectedLevels?.has('G') && selectedRounds === '' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/oldest-grand-slam-quarterfinalists') && selectedSurfaces?.size === 0 && selectedLevels?.has('G') && selectedRounds === 'QF' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/oldest-grand-slam-semifinalists') && selectedSurfaces?.size === 0 && selectedLevels?.has('G') && selectedRounds === 'SF' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
          ...
          <p>
            In the modern era, the leading name is <span className="inline-flex items-center gap-2"><Flag ioc="SRB" className="w-4 h-3" /><span>Novak Djokovic</span></span>. On <strong className="!text-amber-300">July 7, 2026</strong>, he reached the <Link href={getTourneyHref({ slug: createSlug('Wimbledon'), year: 2026 })} className="!text-orange-300 hover:!text-orange-100 font-semibold">Wimbledon 2026</Link> semifinals at age <strong className="!text-amber-300">39 years and 46 days</strong>, defeating <span className="inline-flex items-center gap-2"><Flag ioc="CAN" className="w-4 h-3" /><span>Felix Auger-Aliassime</span></span> 6-4, 5-7, 6-4, 6-4 in the quarter-finals. That run pushed Djokovic beyond his own Australian Open 2026 mark and made him the oldest modern Grand Slam semifinalist outside the Rosewall and Gonzales entries at the top of the list.
          </p>
          <p>
          ...
          <p>
            The record number remains 42: Ken Rosewall is the oldest Grand Slam men’s singles semifinalist of the Open Era, followed by Pancho Gonzales at 40 and Rosewall again at 39. Djokovic now owns the strongest modern-era mark at 39 years and 46 days, ahead of Federer’s late-career semifinal runs.
          </p>
        </div>
      )}

      {isPath('/records/oldest-masters-1000-semifinalists') && selectedSurfaces?.size === 0 && selectedLevels?.has('M') && selectedRounds === 'SF' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/oldest-masters-1000-quarterfinalists') && selectedSurfaces?.size === 0 && selectedLevels?.has('M') && selectedRounds === 'QF' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/oldest-grand-slam-finalists') && selectedSurfaces?.size === 0 && selectedLevels?.has('G') && selectedRounds === 'F' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/oldest-masters-1000-finalists') && selectedSurfaces?.size === 0 && selectedLevels?.has('M') && selectedRounds === 'F' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/oldest-players-in-main-draw-at-masters-1000') && selectedSurfaces?.size === 0 && selectedLevels?.has('M') && selectedRounds === '' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/oldest-players-in-main-draw-on-hard-court') && selectedSurfaces?.has('Hard') && selectedLevels?.size === 0 && selectedRounds === '' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/oldest-players-in-main-draw-on-clay-court') && selectedSurfaces?.has('Clay') && selectedLevels?.size === 0 && selectedRounds === '' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/oldest-players-in-main-draw-on-grass-court') && selectedSurfaces?.has('Grass') && selectedLevels?.size === 0 && selectedRounds === '' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
      ...
      {isPath('/records/oldest-players-in-main-draw-on-carpet-court') && selectedSurfaces?.has('Carpet') && selectedLevels?.size === 0 && selectedRounds === '' && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
