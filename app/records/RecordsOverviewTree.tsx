...
const treeData: Node[] = [
  ...
  { key: 'entries', label: 'Entries', href: '/records/entries' },
  {
    ...
    children: [
      ...
      { key: 'oldest-winners', label: 'Oldest Winners', href: '/records/ages/oldest-winners' },
      { key: 'youngest-winners', label: 'Youngest Winners', href: '/records/ages/youngest-winners' },
