  ...
  return (
    <section className="mb-8">
      ...
      {isMostWinsAtSingleGrandSlamTournament && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 text-gray-200">
          <p>
            At the top of the Open Era list for <strong>Most Wins at a Single Grand Slam Tournament</strong> stands <span className="inline-flex items-center gap-2"><Flag ioc="ESP" className="w-4 h-3" /><span>Rafael Nadal</span></span>, with <strong className="!text-amber-300">112</strong> match wins at Roland Garros — the highest recorded men’s singles total at any major tournament. Guinness records Nadal’s Roland Garros dominance as <strong className="!text-amber-300">112</strong> wins from <strong className="!text-amber-300">115</strong> matches, alongside his unmatched 14 French Open titles. Wimbledon now tells the next chapter of the story: <span className="inline-flex items-center gap-2"><Flag ioc="SRB" className="w-4 h-3" /><span>Novak Djokovic</span></span> has moved ahead there with <strong className="!text-amber-300">{djokovicWimbledonWins}</strong> wins, one clear of <span className="inline-flex items-center gap-2"><Flag ioc="CHE" className="w-4 h-3" /><span>Roger Federer</span></span>'s <strong className="!text-amber-300">105</strong>.
          </p>
          <p>
            That Wimbledon move is what reshapes the leaderboard logic here: Federer still owns the men’s Open Era record of <strong className="!text-amber-300">8</strong> titles, but Djokovic now owns the match-win edge at the All England Club thanks to his <strong className="!text-amber-300">{djokovicWimbledonWins}</strong> victories.
          </p>
          <p>
