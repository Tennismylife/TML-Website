  ...
  return (
    <section className="mb-8">
      ...
      {isMostMatchesPlayedAtSingleGrandSlamTournament && (
        <div className="mb-6 p-6 bg-gray-800 rounded-lg shadow-lg text-sm leading-relaxed space-y-3 !text-gray-200">
          <p>
            At the top of the Open Era list for Most Matches Played at a Single Grand Slam Tournament now stands {renderPlayerLink('Novak Djokovic', 'novak-djokovic', 'SRB')}, who has reached <strong className="!text-amber-300">121</strong> matches at Roland Garros. That puts him ahead of Federer’s Wimbledon benchmark and gives Roland Garros the new ceiling in the major-by-major longevity race.
          </p>
          <p>
            Behind him is {renderPlayerLink('Roger Federer', 'roger-federer', 'CHE')} at <Link href={getTourneyHref({ slug: 'wimbledon' })} className="!text-orange-300 hover:!text-orange-100 font-semibold">Wimbledon</Link>, with <strong className="!text-amber-300">119</strong> matches played and a 105-14 record. That had long been the benchmark for this record, built across 22 Wimbledon appearances, 8 titles and 12 finals. Another key line in the same ranking is Federer at the <Link href={getTourneyHref({ slug: 'australian-open' })} className="!text-orange-300 hover:!text-orange-100 font-semibold">Australian Open</Link>, with <strong className="!text-amber-300">117</strong> matches played.
          </p>
          <p>
            Another major benchmark is {renderPlayerLink('Rafael Nadal', 'rafael-nadal', 'ESP')} at <Link href={getTourneyHref({ slug: 'roland-garros' })} className="!text-orange-300 hover:!text-orange-100 font-semibold">Roland Garros</Link>, with <strong className="!text-amber-300">116</strong> matches played from a staggering 112-4 record. Nadal’s total is slightly below Federer’s Wimbledon volume, but his Paris résumé is unmatched for dominance: 14 Roland Garros titles, a 96.5/96.6% win rate, and only four defeats across 19 editions.
          </p>
          <p>
            A classic Open Era reference point is {renderPlayerLink('Jimmy Connors', 'jimmy-connors', 'USA')} at the <Link href={getTourneyHref({ slug: 'us-open' })} className="!text-orange-300 hover:!text-orange-100 font-semibold">US Open</Link>, where he played <strong className="!text-amber-300">115</strong> matches, built from a 98-17 record. Connors’ case is the old-school longevity model: five US Open titles, appearances across the 1970s, 1980s and early 1990s, and one of the longest single-major careers in men’s tennis history.
          </p>
          <p>
            In this record, the milestone is not simply winning the most matches, but accumulating the greatest total of matches played at one Slam: {renderPlayerLink('Novak Djokovic', 'novak-djokovic', 'SRB')} now sets the ceiling at <Link href={getTourneyHref({ slug: 'roland-garros' })} className="!text-orange-300 hover:!text-orange-100 font-semibold">Roland Garros</Link> with <strong className="!text-amber-300">121</strong>, Federer’s Wimbledon mark remains at <strong className="!text-amber-300">119</strong>, and the rest of the list is still anchored by {renderPlayerLink('Roger Federer', 'roger-federer', 'CHE')} at <Link href={getTourneyHref({ slug: 'australian-open' })} className="!text-orange-300 hover:!text-orange-100 font-semibold">Australian Open</Link> with <strong className="!text-amber-300">117</strong>, {renderPlayerLink('Rafael Nadal', 'rafael-nadal', 'ESP')} at <Link href={getTourneyHref({ slug: 'roland-garros' })} className="!text-orange-300 hover:!text-orange-100 font-semibold">Roland Garros</Link> with <strong className="!text-amber-300">116</strong>, and {renderPlayerLink('Jimmy Connors', 'jimmy-connors', 'USA')} at the <Link href={getTourneyHref({ slug: 'us-open' })} className="!text-orange-300 hover:!text-orange-100 font-semibold">US Open</Link> with <strong className="!text-amber-300">115</strong>.
          </p>
        </div>
      )}
